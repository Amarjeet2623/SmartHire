...
const handleSignup = async (e: React.FormEvent) => {
  ...
  try {
    ...
    // Optional: Save metadata in your backend
    await apiClient.post("/api/auth/signup-metadata", {
      uid: user.uid,
      displayName,
      email: user.email,
    });
  ...
  return (
    <>
      ...
      <div className="min-h-[calc(100vh-80px)] flex">
        ...
        <div className="hidden lg:flex w-1/2 bg-gradient-to-br from-theme-blue to-theme-darkSlate items-center justify-center p-12 text-white flex-col relative overflow-hidden">
